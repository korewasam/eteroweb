                    ...
                    <div ref={this.workbackRef1} className="workBack">
                        ...
                        <div className = 'nairobi' >
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 309 219.12">
                                ...
                                <g ref = {this.circle1} id="circle1"><circle class="cls-1" cx="33.7" cy="123.95" r="13.3"/></g>
                                <g ref = {this.circle2} id="circle2"><circle class="cls-2" cx="77.12" cy="81.03" r="14.51"/></g>
                                <g ref = {this.circle3} id="circle3"><circle class="cls-3" cx="102.75" cy="139.51" r="13.3"/></g>
                                <g ref = {this.circle4} id="circle4"><circle class="cls-1" cx="128.73" cy="37.95" r="13.3"/></g>
                                <g ref = {this.circle5} id="cirlce5"><circle class="cls-1" cx="164.15" cy="93.04" r="14.51"/></g>
                                <g ref = {this.circle6} id="circle6"><circle class="cls-2" cx="196.67" cy="18.51" r="14.51"/></g>
                                <g ref = {this.circle7} id="cirlce7"><circle class="cls-1" cx="196.75" cy="123.4" r="10.48"/></g>
                                <g ref = {this.circle8} id="circle8"><circle class="cls-4" cx="260.81" cy="114.33" r="10.48"/></g>
                                <g ref = {this.buttRef} id="button"><rect class="cls-1" y="144.12" width="309" height="75" rx="9.76" ry="9.76"/>
                                <path class="cls-5" d="M134.78,171.28h2.52v17.63h-2.85V177.26l-4.65,8.8h-2.15L123,177.38l0,11.53h-2.85V171.28h2.55l6,11.53Z"/>
                                <path class="cls-5" d="M144.51,188a7.29,7.29,0,0,1-2.91-3.15,11.81,11.81,0,0,1,0-9.58,7.2,7.2,0,0,1,2.91-3.14,9.63,9.63,0,0,1,8.94,0,7.29,7.29,0,0,1,2.9,3.14,11.81,11.81,0,0,1,0,9.58,7.37,7.37,0,0,1-2.92,3.15,8.57,8.57,0,0,1-4.43,1.1A8.67,8.67,0,0,1,144.51,188Zm8.25-3.15a9.06,9.06,0,0,0,0-9.58,5.16,5.16,0,0,0-7.6,0,9.12,9.12,0,0,0,0,9.58,5.14,5.14,0,0,0,7.6,0Z"/>
                                <path class="cls-5" d="M175.37,188.91h-3.5l-3-5.63a2.55,2.55,0,0,0-1-1.12,3.36,3.36,0,0,0-1.58-.33h-2.44v7.08H160.6V171.28h7.8a6.84,6.84,0,0,1,4.56,1.34,4.81,4.81,0,0,1,1.57,3.86,4.9,4.9,0,0,1-1.14,3.34,5.4,5.4,0,0,1-3.21,1.71,3.65,3.65,0,0,1,2.25,2Zm-4.75-10.24a2.54,2.54,0,0,0,.85-2.11,2.49,2.49,0,0,0-.85-2.11,4.26,4.26,0,0,0-2.67-.67h-4.2v5.58H168A4.19,4.19,0,0,0,170.62,178.67Z"/>
                                <path class="cls-5" d="M178,188.91V171.28h11.81v2.55h-8.66v4.85h8.16v2.53h-8.16v5.15h8.66v2.55Z"/></g></g>
                                </svg>
                                </div>
                        </div>
                    </div>
                    <div ref = {this.workbackRef2} className="workBack2">
                        <div className="work2">
                            ...
                            <svg width="309" height="220" viewBox="0 0 309 220" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path id="Vector_2" d="M77.12 95.54C85.1337 95.54 91.63 89.0436 91.63 81.03C91.63 73.0163 85.1337 66.52 77.12 66.52C69.1064 66.52 62.61 73.0163 62.61 81.03C62.61 89.0436 69.1064 95.54 77.12 95.54Z" stroke="#DE4C6F" stroke-width="8" stroke-miterlimit="10"/>
                                </g>
                                <g ref = {this.motoC3} id="circle3">
                                <path id="Vector_3" d="M102.75 152.81C110.095 152.81 116.05 146.855 116.05 139.51C116.05 132.165 110.095 126.21 102.75 126.21C95.4046 126.21 89.45 132.165 89.45 139.51C89.45 146.855 95.4046 152.81 102.75 152.81Z" stroke="#DE4C6F" stroke-width="5" stroke-miterlimit="10"/>
                                </g>
                                ...
                                <path id="Vector_6" d="M196.67 33.02C204.684 33.02 211.18 26.5237 211.18 18.51C211.18 10.4963 204.684 4 196.67 4C188.656 4 182.16 10.4963 182.16 18.51C182.16 26.5237 188.656 33.02 196.67 33.02Z" stroke="#DE4C6F" stroke-width="8" stroke-miterlimit="10"/>
                                </g>
                                ...
                                <path id="Vector_8" d="M260.81 124.81C266.598 124.81 271.29 120.118 271.29 114.33C271.29 108.542 266.598 103.85 260.81 103.85C255.022 103.85 250.33 108.542 250.33 114.33C250.33 120.118 255.022 124.81 260.81 124.81Z" stroke="#DE4C6F" stroke-width="6" stroke-miterlimit="10"/>
                                </g>
                                <g id="button">
